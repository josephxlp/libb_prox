...
def match_baseline_to_12m_files(basefile,D12PATH,DXPATH,VAROI):
...
VAROI = RESAMPLE_VAR_ENGING + RESAMPLE_VAR_SPECTIAL_ENGING

def process_raster(varname, GRID, TILESX_DPATH, OPEN_TOPOGRAPHY_DPATH, TILES12_DPATH, DXPATH,VAROI):
    """
    ...
    for basefile in basefiles:
        ...
        t12files, txfiles = match_baseline_to_12m_files(basefile, TILES12_DPATH, DXPATH,VAROI)
...
def main():
    ...
    with ProcessPoolExecutor() as executor:
        ...
        for i, varname in enumerate(varname_list):
            ...
            futures.append(executor.submit(process_raster, varname, GRID, TILESX_DPATH, OPEN_TOPOGRAPHY_DPATH, TILES12_DPATH, DXPATH,VAROI))
